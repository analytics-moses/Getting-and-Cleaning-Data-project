...
#### A  vector representing _activity tags_:
c("WALKING", "WALKING_UPSTAIRS", "WALKING_DOWNSTAIRS", "SITTING", "STANDING", "LAYING")

#### A vector respresenting _activities_
c(1, 2, 3, 4, 5, 6)
...
#### A vector for the extracted _features_:
c(1, ..., 543)

#### A vector for the extracted _Feature Tags_:
